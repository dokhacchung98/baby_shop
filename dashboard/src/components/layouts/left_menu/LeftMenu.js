...
const LeftMenu = (props) => {
    ...
    useEffect(() => {
        const tmp = localStorage.getItem('isadmin') || false;
        setIsAdmin(tmp);
    }, []);
                    ...
                    </ul>
                    {
                        isAdmin && (
                            <div>
                                ...
                                <ul className="navbar-nav flex-column">
                                    <li className="nav-item">
                                        <a className="nav-link collapsed" href="/#" data-toggle="collapse" data-target="#User_drp_1" aria-expanded="false">
                                            <span className="icon-user mr-3"></span>
                                            <span className="nav-link-text">Phân Quyền</span>
                                        </a>
                                        <ul id="User_drp_1" className="nav flex-column collapse collapse-level-1">
                                            <li className="nav-item">
                                                <ul className="nav flex-column">
                                                    <li className="nav-item">
